...
#Bug detected:
    ...
    #when clicking show password when we want to change the password it shows the password of all the typed password:
        #that is it shows the (current password, new pasword, repeat password)
#***************************
...
def Buttons(Driver):
    ...
    # LoginLink.click()
    # time.sleep(3)
    # Email2 = Driver.find_element(by=By.XPATH,value='/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText')
    # Email2.click()
    # time.sleep(3)
    # email = "user1@gmail.com"
    # password = "password"
